...
- When an indexed movie has no saved MediaGrap draft, its same-basename Kodi NFO is read on opening the detail view and used as the editable starting draft. The original NFO remains unchanged until an explicit write plan is applied.
